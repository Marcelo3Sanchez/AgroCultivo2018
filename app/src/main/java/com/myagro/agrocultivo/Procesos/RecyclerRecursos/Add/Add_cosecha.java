...
public class Add_cosecha extends AppCompatActivity {

    String URL_POST_add_cosecha = R.string.host+"add_cultivo.php";
    String idCultivo;
    View focusView = null;
...
public void validar(){
    ...
    public  void insertar_cosecha(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_POST_add_cosecha, new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Add_cosecha.this , error+"", Toast.LENGTH_SHORT).show();
            }
        }){
