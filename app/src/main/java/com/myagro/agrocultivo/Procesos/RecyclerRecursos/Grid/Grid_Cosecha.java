...
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Add.Add_cosecha;
...
public class Grid_Cosecha extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                case R.id.navigation_home:
                    Intent inicio = new Intent(Grid_Cosecha.this, com.myagro.agrocultivo.home.class);
                    finish();
                    startActivity(inicio);

                    return true;
                case R.id.navigation_micultivo_recurs:
                    Intent cult = new Intent(Grid_Cosecha.this, MisCultivosGrid.class);
                    finish();
                    startActivity(cult);

                    return true;
                case R.id.navigation_add_recurs:
                    Intent add = new Intent(Grid_Cosecha.this, Add_cosecha.class);
    ...
    public void onResponse(JSONObject response) {
        ...
        JSONArray json = response.optJSONArray("cosecha");
    ...
    private void cargarService(){
        String url =getString(R.string.host)+"cosecha.php?id="+idCultivo;
