...
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Add.Add_cant_cosecha;
...
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.RecyclerView.RecyclerViewAdap_cant_cosecha;
...
public class Grid_cant_cosechada extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_add_recurs:
                    Intent add = new Intent(getApplication(), Add_cant_cosecha.class);
    ...
    public void onResponse(JSONObject response) {
        ...
        JSONArray json = response.optJSONArray("cosecha_cantidad");
        ...
        try {
            ...
            for (int i = 0; i <json.length() ; i++) {
                ...
                Prorecursos.setVal_inversion(jsonObject.optString("cantidad"));
            ...
            RecyclerViewAdap_cant_cosecha myAdapter = new RecyclerViewAdap_cant_cosecha(this,this,lstRecurso);
    ...
    private void cargarService(){
        String url ="http://206.189.165.63/cosechacantidades/obtener/id_cultivo/"+idCultivo;
