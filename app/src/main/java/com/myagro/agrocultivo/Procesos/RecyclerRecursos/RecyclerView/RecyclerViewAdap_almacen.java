...
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Edit.Edit_Almacen;
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Edit.Edit_venta;
import com.myagro.agrocultivo.R;

import java.util.List;

public class RecyclerViewAdap_almacen extends RecyclerView.Adapter<RecyclerViewAdap_almacen.MyViewHolder> {
    ...
    public RecyclerViewAdap_almacen(Context contextos, Context mContext, List<Card_recursos> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.tv_cant_recurs.setText("Cant :"+mData.get(position).getN_horas()+" Kg");
        ...
        holder.cardView_recurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Edit_Almacen(contextos,recurso,cant,inversion,nota);
            }
        });
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(View itemView) {
            ...
            tv_cant_recurs = (TextView)itemView.findViewById(R.id.n_horas_recurs);
