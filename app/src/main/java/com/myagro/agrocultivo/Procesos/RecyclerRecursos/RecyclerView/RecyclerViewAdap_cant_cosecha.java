...
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Editar.Put_cantidad_cosecha;
...
public class RecyclerViewAdap_cant_cosecha extends RecyclerView.Adapter<RecyclerViewAdap_cant_cosecha.MyViewHolder> {
    ...
    public RecyclerViewAdap_cant_cosecha(Context contextos, Context mContext, List<Card_recursos> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.tv_nhora_recurs.setText("");
        holder.tv_val_inver_recurs.setText("Cantidad: "+mData.get(position).getVal_inversion()+"  kg");
        ...
        holder.cardView_recurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent recurs = new Intent (mContext, Put_cantidad_cosecha.class);
