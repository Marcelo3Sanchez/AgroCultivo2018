...
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Editar.Put_fer_maleza;
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Editar.Put_siembra;
import com.myagro.agrocultivo.R;

import java.util.List;


public class RecyclerViewAdap_fer_maleza extends RecyclerView.Adapter<RecyclerViewAdap_fer_maleza.MyViewHolder> {
    ...
    public RecyclerViewAdap_fer_maleza(Context contextos, Context mContext, List<Card_recursos> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.tv_nhora_recurs.setText(mData.get(position).getN_horas()+" Lt/Kg");
        ...
        holder.cardView_recurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent recurs = new Intent (mContext, Put_fer_maleza.class);
                //enviar id del cultivo a Procesos class
                recurs.putExtra("id_recurso",mData.get(position).getId());
                recurs.putExtra("name_componente", mData.get(position).getTipo_recurso());
                recurs.putExtra("cantidad",mData.get(position).getN_horas());
