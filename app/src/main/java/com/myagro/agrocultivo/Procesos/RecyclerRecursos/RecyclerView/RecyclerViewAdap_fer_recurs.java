...
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Editar.Put_fer_recursos;
...
public class RecyclerViewAdap_fer_recurs extends RecyclerView.Adapter<RecyclerViewAdap_fer_recurs.MyViewHolder> {
    ...
    public RecyclerViewAdap_fer_recurs(Context contextos, Context mContext, List<Card_recursos> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cardView_recurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent recurs = new Intent (mContext, Put_fer_recursos.class);
