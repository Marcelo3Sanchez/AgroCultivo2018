...
public class RecyclerViewAdap_pre_terreno extends RecyclerView.Adapter<RecyclerViewAdap_pre_terreno.MyViewHolder> {
    ...
    public RecyclerViewAdap_pre_terreno(Context contextos, Context mContext, List<Card_recursos> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cardView_recurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent recurs = new Intent (mContext, Put_pre_terreno.class);
