...
import com.myagro.agrocultivo.Procesos.RecyclerRecursos.Edit.Edit_procesos;
...
public class RecyclerViewAdap_recursos extends RecyclerView.Adapter<RecyclerViewAdap_recursos.MyViewHolder> {

    private Context contextos;
    private Context mContext;
    private List<Card_recursos> mData;
    String recurso,hora,inversion,nota;


    public RecyclerViewAdap_recursos(Context contextos,Context mContext, List<Card_recursos> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cardView_recurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                hora = mData.get(position).getN_horas();
                inversion = mData.get(position).getVal_inversion();
                nota = mData.get(position).getNotas();
                new Edit_procesos(contextos,recurso,hora,inversion,nota);
            }
        });
