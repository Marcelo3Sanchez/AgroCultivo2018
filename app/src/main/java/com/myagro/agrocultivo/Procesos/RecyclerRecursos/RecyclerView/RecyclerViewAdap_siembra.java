...
public class RecyclerViewAdap_siembra extends RecyclerView.Adapter<RecyclerViewAdap_siembra.MyViewHolder> {
    ...
    public RecyclerViewAdap_siembra(Context contextos, Context mContext, List<Card_recursos> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.cardView_recurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent recurs = new Intent (mContext, Put_siembra.class);
