...
public class RecyclerViewAdap_venta extends RecyclerView.Adapter<RecyclerViewAdap_venta.MyViewHolder> {
    ...
    public RecyclerViewAdap_venta(Context contextos,Context mContext, List<Card_recursos> mData) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.tv_val_inver_recurs.setText("Precio $"+mData.get(position).getVal_inversion());
        ...
        holder.cardView_recurs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new Edit_venta(contextos,recurso,cant,inversion,nota);
